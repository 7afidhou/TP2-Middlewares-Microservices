...
public class MsScolariteApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        ...
        etudiantRep.save(new Etudiant(null, "ismail", "isi",
                Date.valueOf("2003-11-11"), Date.valueOf("2003-11-11"), e1, 2L, null));
        etudiantRep.save(new Etudiant(null, "krimo", "isi",
                Date.valueOf("2003-11-11"), Date.valueOf("2003-11-11"), e2, 1L, null));
        etudiantRep.save(new Etudiant(null, "ilyes", "isi",
                Date.valueOf("2003-11-11"), Date.valueOf("2003-11-11"), e3, 1L, null));
